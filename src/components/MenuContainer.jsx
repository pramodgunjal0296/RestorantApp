...
const MenuContainer = () => {
    ...
    return (
        ...
        before:absolute before:rounded-lg before:content before:w-16
        ...
        lg:justify-center gap-8 py-6 overflow-x-scroll scrollbar-none'>
                ...
                ${filter === category.urlParamName
                  ...
                  w-24 min-w-[94px] h-28 cursor-pointer rounded-lg drop-shadow-lg flex flex-col
           gap-3 items-center hover:bg-cartNumBg`}>
